...
<html lang="en-us">	
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="{{ url('assets/css/smartadmin-production-plugins.css') }}">
		<link rel="stylesheet" type="text/css" media="screen" href="{{ url('assets/css/smartadmin-production.css') }}">
		<link rel="stylesheet" type="text/css" media="screen" href="{{ url('assets/css/smartadmin-skins.css') }}">
	...
	<body class="fixed-header fixed-navigation fixed-ribbon">
		...
		<aside id="left-panel">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as is --> 
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<img src="{{ url('assets/img/avatars/sunny.png') }}" alt="me" class="online" /> 
						<span>
							john.doe 
						</span>
			...
			<nav>
				...
				<ul>
					...
					<li>
						<a href=""><i class="fa fa-lg fa-fw fa-pencil-square-o"></i> <span class="menu-item-parent">Mahasiswa</span></a>
						<ul>
		...
		<!-- Link to Google CDN's jQuery + jQueryUI; fall back to local -->
	    <script src="{{ url('assets/js/libs/jquery-2.1.1.min.js') }}"></script>

	    <script src="{{ url('assets/js/libs/jquery-ui-1.10.3.min.js') }}"></script>
