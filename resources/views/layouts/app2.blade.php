...
@show
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo theme-color theme-color-default">
                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>@yield('content_title', 'your title here')
                                <small>@yield('content_title_small', 'your title here')</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                    </div>
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        <li>
                            <a href="@yield('yield_url', 'yourURL')">@yield('step_breadcrumb', 'your title here')</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <a href="@yield('yield_url2', 'yourURL')">@yield('step_breadcrumb2')</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <a href="@yield('yield_url3', 'yourURL')">@yield('step_breadcrumb3')</a>
